...
use crate::tempfile::TempfileError::FileIo;
use crate::Field;
...
pub struct TempfileConfig {
    err_handler: Option<Arc<dyn Fn(TempfileError, &HttpRequest) -> actix_web::Error + Send + Sync>>,
...
impl TempfileConfig {
    ...
    where
        F: Fn(TempfileError, &HttpRequest) -> actix_web::Error + Send + Sync + 'static,
    {
    ...
    fn map_error(&self, req: &HttpRequest, field_name: &str, err: TempfileError) -> crate::Error {
